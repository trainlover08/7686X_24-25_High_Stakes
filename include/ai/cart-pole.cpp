...
void trainCartPolePolicyGradient(NeuralNetwork& actor, NeuralNetwork& critic, LinearRegression& env, int numEpisodes, double gamma, double learningRate, double GRADIENT_CLIP_THRESHOLD, double weight_decay) {
    AdamWOptimizer actorOptimizer(0.005, 0.9, 0.999, 0.01, weight_decay);
    AdamWOptimizer criticOptimizer(0.00001, 0.9, 0.999, 0.01, weight_decay);
...
int main() {
    ...
    trainCartPolePolicyGradient(actor, critic, env, 2500, 0.99, 0.001, 0.1, 1e-4);
